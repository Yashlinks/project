...
<section id="packages">
    ...
    <?php
        $id = (isset($_GET['id']));
        $query = "SELECT * FROM standard_package WHERE id = '$id'";
    ...
    ?>
        <div class="pkg_cont">
           ...
           <ul class="pkg_itm" type="disk">
                ...
                <li><input type="text" id="benefit3" name="benefit3" value="<?php echo $result['benefit3']; ?>"></li>
       </div>  
       </div>
       <div class="btn-container">
           <h2> <input type="submit" id="update-standard" name="update-standard" value="Update">
                </h2> 
        </div>
       </div>
    </form>
...
if(isset($_POST['update-standard']))
{
    ...
    $befit3 = $_POST['benefit3'];

    $query = "UPDATE standard_package SET price='$price',photographer='$photo',videographer='$video',video_coverage='$coverage',digital_files='$files',album='$album',dvd='$dvd',benefit1='$befit1',benefit2='$befit2',benefit3='$befit3' WHERE id ='$id'"; 
