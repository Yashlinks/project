...
<section id="packages">
    ...
    <?php
        $id = (isset($_GET['id']));
        $query = "SELECT * FROM pro_package WHERE id = '$id'";
    ...
    ?>
       ...
       <div class="btn-container">
           <h2> <input type="submit" id="update-pro" name="update-pro" value="Update">
                </h2> 
        </div>
       </div>
    </form>
...
if(isset($_POST['update-pro']))
{
    ...
    $query = "UPDATE pro_package SET price='$price',photographer='$photo',videographer='$video',video_coverage='$coverage',digital_files='$files',album='$album',dvd='$dvd',benefit1='$befit1',benefit2='$befit2',benefit3='$befit3' WHERE id ='$id'"; 
